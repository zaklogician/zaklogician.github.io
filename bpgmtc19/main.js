...
var _user$project$MTUK_LocalAPI$get = function (key) {
	var _p0 = key;
	switch (_p0) {
		case 'abstracts':
			return 'The schedule and abstracts will be announced shortly.';
		case 'participants':
			return '...';
		case 'speaker1':
			return 'Imperial College of Science, Technology and Medicine, London - [webpage](https://www.imperial.ac.uk/people/c.kestner)';
		case 'speaker2':
			return 'University of Konstanz - [webpage](http://www.math.uni-konstanz.de/~kuhlmann/)';
		case 'speaker3':
			return 'University of Manchester / University of Oxford - [webpage](http://www.maths.manchester.ac.uk/~awilkie/)';
		case 'speaker4':
			return 'Institut Camille Jordan, Villeurbanne - [webpage](http://math.univ-lyon1.fr/~begnac/)';
		case 'support':
			return 'We thank the [London Mathematical Society](https://www.lms.ac.uk/) and the [Manchester Institute for Mathematical Sciences](http://www.maths.manchester.ac.uk/our-research/about-mims) for their generous support.';
		case 'venue':
			return 'The conference will be held at the Alan Turing Building (M13 9PY) of the School of Mathematics, University of Manchester. Follow the signs to Frank Adams Room on the first floor. The conference dinner will take place in [Zouk](https://zoukteabar.co.uk/menus/manchester/) (scroll down for directions).\n<div style=\"width: 100%; max-height: 400px !important;\"><iframe width=\"100%\" height=\"400\" src=\"https://maps.google.com/maps?width=100%&amp;hl=en&amp;q=Alan%20Turing%20Building%2C%20Manchester+(Alan%20Turing%20Building)&amp;ie=UTF8&amp;t=&amp;z=16&amp;iwloc=B&amp;output=embed\" frameborder=\"0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\"></iframe></div>\n\n#### Points of Interest\n\n<img src=\"./images/bpgmtc-map.png\" style=\'width:100%;\' border=\"0\" alt=\"Map\">\n\nClick [here](./images/food-recommendations.pdf) for food and tea recommendations close to the ibis Hotel and to Alan Turing Building.\n\n#### Getting to Manchester\n\n**By rail.** Most cities across England have direct train services to Manchester Piccadilly station, which is a 15 minute walk from the University campus. Manchester Oxford Road is a commuter train station which is slightly closer to the Alan Turing Building. Please see the National Rail website for tickets and timetables. We recommend booking your train tickets in advance, especially if you\'re traveling from London.\n\n**By air.** Manchester International Airport has flights from over 200 destinations worldwide and has a direct train connection to Manchester Oxford Road station. Other nearby airports are Liverpool Airport (33 miles) and Leeds Bradford (46 miles).\n\n';
		case 'abstracts2':
			return '###### **Itaï Ben Yaacov** (University of Lyon 1) - Short course: Continuous logic, metric structures and separable categoricity.\n\nIn this tutorial, I intend to give a general presentation of continuous first order logic as a formalism for the model theory of complete metric structures, such as may arise in probability theory, functional analysis, topological dynamics, and other areas of mathematics. One of my major aims is to discuss separably categorical theories, analogous to countably categorical theories in classical first order logic.\n\n1. The Ryll-Nardzewski characterisation of countably categorical theories extends to separably categorical ones. We may use this to prove uniformity results which are of interest to Banach space theorists.\n\n2. To a separably categorical theory one can associate the automorphism group of its unique model. Groups arising in this fashion are the Roelcke precompact Polish groups, many of which are of independent interest (the infinite-dimensional unitary group, the group of measure-preserving automorphisms of the interval, the group of measure-class-preserving automorphisms of the interval, the homeomorphism group of the interval, ...) In some cases, model-theoretic properties of the theory give us surprising insight into properties of the corresponding group.\n\n3. Conversely, a separably categorical theory is determined, up to bi-interpretation, by the associated automorphism group. Certain properties of the theory (most notably stability and NIP) correspond to properties of the group which may be called \"dynamical\", and further, to various possible properties of Banach space. This can be used to show, for example, preservation of stability and NIP under some model-theoretic constructions.\n\n\n###### **Tim Clausen** (University of Münster) - Dp–minimal profinite groups.\n\nLet G be an infinite profinite group with a fixed fundamental system of open subgroups. We view G as a two-sorted structure (G,I) where the second sort is used to make the open subgroups in the fundamental system uniformly definable. We study those structures (G,I) for which (G,I) is NIP and the group sort is dp-minimal.\n\n\n###### **Esther Elbaz–Saban** (Université Paris Diderot) - Grothendieck ring of pairing function with no cycles.\n\nIf \\(p\\) is a bijection between a set \\(M\\) and \\(M^2\\), we say that it is a pairing function with no cycles if for any term \\(t(x_1,.. ., x_n)\\) formed with \\(p\\), and that is not a variable, we have, for every \\(a_1,\\ldots, a_n \\in M\\), \\(t(a_1,\\ldots, a_n) \\neq a_1\\). The theory of pairing functions has been studied by several authors and, in particular, it has been shown that it is complete and admits quantifier elimination in a natural language.\nGrothendieck rings of a structure have been introduced in Model Theory in 2000. Its construction relies on indentifying definable sets that are in definable bijection and generalizes the definition of Grothendieck ring already know in algebraic geometry.\nWe will first give a brief survey of this model theoretic notion. Then we\'ll compute the Grothendieck ring of pairing function with no cycles, and show that it is isomorphic to \\(\\mathbb{Z}[x]/(X-X^2)\\) itself isomorphic to \\(\\mathbb{Z}\\times \\mathbb{Z}\\).\n\n\n###### **Charlotte Kestner** (Imperial College London) - Stability and pseudofinite structures.\n\nI will give an introduction to pseudofinite structures, in particular results relating to the stability universe. I will then focus on the NSOP hierarchy, highlighting open questions, and some recent work joint with Sylvy Anscombe on the two sorted stucture of a vector space over a pseudofinite field with a bilinear form.\n\n###### **Thomas Kirk** (University of Central Lancashire) - Definable Topological Dynamics in Metastable Theories.\n\nWe consider a dynamical system where a definable group acts on its space of complete types. Specifically, we will consider an affine algebraic group definable in a metastable theory and consider the minimal ideals of this action. We give a full description for the Minimal Flows, and Ellis Group, of some of these groups, and note that this is not isomorphic to \\(G/G^{00}\\); providing a negative answer as to whether metastability is a suitable weakening of a since disproven conjecture of Newelski. Further, we discuss recent work in ACVF where G admits a stably dominated / definably amenable group decomposition (possibly with non-trivial intersection) and show work towards a description of the Ellis Group in this setting.\n\n###### **Matěj Konečný** (Charles University, Prague) - Binary symmetric Ramsey classes.\n\nA structure is homogeneous if every isomorphism of its finite substructures extends to an automorphism of the whole structure. A homogeneous structure is Ramsey if its automorphism group is extremely amenable, that is, every continuous action on a compact space has a fixed point. For every countable homogeneous structure, the class of all its finite substructures has the amalgamation property. Using the KPT correspondence, one can equivalently define the Ramsey property for an amalgamation class in a purely combinatorial manner.\nMost of the known Ramsey structures in a binary symmetric language satisfies some variant of the triangle inequality (the rational Urysohn space, Sauer\'s \\(S\\)-metric spaces, Cherlin\'s metrically homogeneous graphs or Braunfeld\'s \\(\\Lambda\\)-ultrametric spaces) and, in turn, their Ramsey expansions can be found using the Hubička--Nešetřil theorem and a variant of the so-called shortest path completion (in particular, using combinatorial methods).\nWe study the limits of the shortest path completion and introduce the semigroup-valued metric spaces --- a general framework which includes all the aforementioned classes. We find their Ramsey expansions and prove EPPA. We also conjecture that every primitive strong amalgamation class in a finite binary symmetric language can be understood as a semigroup-valued metric space.\nThis is joint work with Hubička and Nešetřil.\n\n\n###### **Salma Kuhlmann** (University of Konstanz) - On ordered fields dense in their real closure and definable convex valuations.\n\nIn ongoing joint work with L. S. Krapp and G. Lehericy (arXiv:1810.10377), we investigate what convex valuations on (totally) ordered fields are definable in the language of ordered rings. This naturally leads towards a systematic study of ordered fields which are dense in their real closure. Some of our results have connections to a conjecture of Shelah on (strongly) dependent fields.\nIn this talk, after summarizing the real algebraic  background (including a related discussion of ordered abelian groups dense in their divisible hull), I will present our valuation theoretic characterization of density and some of its consequences.  I will then proceed to a reformulation of the above conjecture for ordered fields, reducing it to an open question on (strongly) dependent archimedean fields.\n\n\n###### **Nadav Meir** (Ben Gurion University of the Negev) - Definably complete expansions without the pigeonhole property.\n\nIn \\(o\\)-minimalism, generalizations of \\(o\\)-minimality such as local \\(o\\)-minimality and definable completeness are studied.\nAn ordered structure \\((M;<,\\dots )\\) is locally \\(o\\)-minimal if for every definable subset \\(X\\subset M\\) and every \\(x\\in M\\), there is some \\(x<y\\in M\\) such that either \\((x,y)\\subseteq X\\) or \\((x,y)\\cap X=\\emptyset\\).\nAn ordered structure \\((M;<,\\dots )\\) is definably complete if every bounded definable subset \\(X\\subset M\\) has a supremum in \\(M\\).\nIn this talk, we will survey some of the results in this area and present an approach to a question asked by several people in the area: Let \\(\\mathcal{R}\\) be an expansion of a ordered field such that every bounded definable subset of \\(\\mathcal{R}\\) has a supremum. Let \\(X\\subseteq\\mathcal{R}\\) be a definable set that\nis closed, bounded and discrete, and let \\(f : X \\to X\\) be definable and injective. Is \\(f\\) surjective?\n\n\n###### **Rosario Mennuni** (University of Leeds) - Products of Invariant Types Modulo Domination–Equivalence.\n\nIn stable theories it is possible to associate to\nsufficiently big models a certain monoid obtained by quotienting\nthe space of types by a relation called \"domination-equivalence\".\nOne can generalize this equivalence relation to arbitrary theories\nand look at the quotient of the space of invariant types, the ones\non which a product is defined. I will discuss some sufficient\nconditions for this product to be a congruence with respect to\ndomination-equivalence, and present a supersimple theory of SU-rank\n2 where it is not.\n\n\n###### **Pierre Touchard** (University of Münster) - Burden in Henselian valued fields.\n\nIn model theory of valued fields, a standard approach to classify a given theory of a Henselian valued field is to reduce the question of its classification to the theory of its value group and that of its residue field. In particular, Chernikov and Simon proved in 2016 that a Henselian valued field of equicharacteristic 0 (with some other assumptions)  is of burden 1 if and only if its residue field and value group are of burden 1, where the burden is the notion of dimension associated to NTP2 (Non Tree Property of the 2nd kind). I will present my work to extend this theorem to any burden and to mixed characteristic Henselian valued fields.\n\n\n###### **Alex Wilkie** (University of Oxford) - \\(\\mathbb{R}_{an, exp}\\).\n\nAfter some introductory comments on the topic of o-minimality I shall focus the rest of the talk on what has turned out to be the most important o-minimal structure for mathematical applications. Namely the eponymous structure, which is obtained by expanding the ordered field of real numbers by the exponential function and by all restricted analytic functions. Some familiarity with the theory of analytic functions of several real variables is required to define \\(\\mathbb{R}_{an, exp}\\) precisely and to prove that it is indeed o-minimal (a result due to L. van den Dries and C. Miller) and I will sketch the main issues here. Various applications (mostly to transcendental number theory) will then be given.\n\n\n###### **Tingxiang Zou** (University of Lyon 1) - Definable groups in supersimple H–structures.\n\nH-structures are expansions of geometric structures with a dense and co-dense algebraically independent set. This construction preserves nice model theoretic properties. Since the geometry on the expended set is trivial, one might wonder if the expansion will not introduce new definable groups. We will give a positive answer in the case of supersimple theories. Namely, in supersimple H-structures, every definable group is definably isomorphic to a group definable in the original language.\n';
		case 'day1':
			return '* **0930** *Welcome*\n* **1000** Itaï Ben Yaacov\n* **1100** *Break*\n* **1130** Rosario Mennuni\n* **1215** *Lunch*\n* **1400** Nadav Meir\n* **1445** *Break*\n* **1500** Salma Kuhlmann\n* **1600** *Break*\n* **1630** Pierre Touchard';
		case 'day2':
			return '* **1000** Itaï Ben Yaacov\n* **1100** *Break*\n* **1130** Matěj Konečný\n* **1215** *Lunch*\n* **1400** Tingxiang Zou\n* **1445** *Break*\n* **1500** Alex Wilkie\n* **1600** *Break*\n* **1630** Tim Clausen\n* **1930** *Conference Meal*';
		case 'day3':
			return '* **1000** Itaï Ben Yaacov\n* **1100** *Break*\n* **1130** Esther Elbaz-Saban\n* **1215** *Lunch*\n* **1400** Thomas Kirk\n* **1445** *Break*\n* **1500** Charlotte Kestner\n';
		case 'information':
			return '<!-- ##### [Click here to register](https://estore.manchester.ac.uk/conferences-and-events/faculty-of-science-engineering/school-of-mathematics/british-postgraduate-model-theory-conference-2018/british-postgraduate-model-theory-conference-2019) -->\n\n##### Registration is now closed.\n\nThe registration fee is £20. Childcare support grants are available from the London Mathematical Society. Details can be found [here](https://www.lms.ac.uk/grants/caring-supplementary-grants).\n\n##### Contact\n\nFor any question/query about the conference, email us at pgmodeltheory@gmail.com. For urgent matters, participants should email Ulla Karhumaki or Deacon Linkhorn at firstname.lastname@manchester.ac.uk.\n\n\n##### Organisers\n\nHarry Gulliver // Ulla Karhumaki // Zoltan Kocsis // Deacon Linkhorn // Shi Qiu // Rose Wagstaffe';
		case 'intro':
			return 'For next year\'s conference see [BPGMTC 2020](https://conferences.leeds.ac.uk/BPGMTC20/).\n\nThe British Postgraduate Model Theory Conference provides an opportunity for postgraduate students and postdoctoral researchers in model theory to present and discuss their work.\n\n**Location**: The University of Manchester // **Date**: January 16th-18th 2019\n\n<img src=\"images/conference-photo.jpg\" style=\'width:100%;\' border=\"0\" alt=\"Conference Photo\">\n\n';
		default:
			return A2(_elm_lang$core$Basics_ops['++'], 'Error: unknown key ', _p0);
	}
};

var _user$project$MTUK_Util$spinner = _debois$elm_mdl$Material_Spinner$spinner(
	{
		ctor: '::',
...
var _user$project$MTUK_Util$spacer = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('mdl-layout-spacer'),
	...
	{ctor: '[]'});
var _user$project$MTUK_Util$spinnerGrid = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('mdl-grid loadlate'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _user$project$MTUK_Util$spacer,
		_1: {
			ctor: '::',
			_0: _user$project$MTUK_Util$spinner,
			_1: {
				ctor: '::',
				_0: _user$project$MTUK_Util$spacer,
				_1: {ctor: '[]'}
...
var _user$project$MTUK_Util$white = _debois$elm_mdl$Material_Color$text(_debois$elm_mdl$Material_Color$white);
var _user$project$MTUK_Util$andThen = F3(
	function (update, msg, _p0) {
		var _p1 = _p0;
...
var _user$project$MTUK_Util$batched = F3(
	function (update, xs, model) {
		var _p3 = xs;
		if (_p3.ctor === '[]') {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		} else {
			return A3(
				_user$project$MTUK_Util$andThen,
				update,
				_p3._0,
				A3(_user$project$MTUK_Util$batched, update, _p3._1, model));
		}
	});
var _user$project$MTUK_Util$nth = F2(
	function (k, xs) {
		return _elm_lang$core$List$head(
			A2(_elm_lang$core$List$drop, k, xs));
	});

var _user$project$MTUK_ContentCard$options = {
	ctor: '::',
	_0: A2(_debois$elm_mdl$Material_Options$css, 'padding-left', '10px'),
	_1: {
		ctor: '::',
		_0: _debois$elm_mdl$Material_Options$cs('mld-cell mdl-cell--12col contentcard'),
		_1: {
			ctor: '::',
...
var _user$project$MTUK_ContentCard$model = F2(
	function (key_, title_) {
		return {key: key_, title: title_, body: _elm_lang$core$Maybe$Nothing, editor: _elm_lang$core$Maybe$Nothing, mdl: _debois$elm_mdl$Material$model};
	});
var _user$project$MTUK_ContentCard$EditorModel = F2(
	function (a, b) {
		return {body: a, passwd: b};
	});
var _user$project$MTUK_ContentCard$Model = F5(
	function (a, b, c, d, e) {
		return {key: a, title: b, body: c, editor: d, mdl: e};
	});
var _user$project$MTUK_ContentCard$ClickCancel = {ctor: 'ClickCancel'};
var _user$project$MTUK_ContentCard$ClickSave = {ctor: 'ClickSave'};
var _user$project$MTUK_ContentCard$ChangePasswd = function (a) {
	return {ctor: 'ChangePasswd', _0: a};
};
var _user$project$MTUK_ContentCard$ChangeBody = function (a) {
	return {ctor: 'ChangeBody', _0: a};
};
var _user$project$MTUK_ContentCard$Init = {ctor: 'Init'};
var _user$project$MTUK_ContentCard$EditorMsg = function (a) {
	return {ctor: 'EditorMsg', _0: a};
};
var _user$project$MTUK_ContentCard$ClickEdit = {ctor: 'ClickEdit'};
var _user$project$MTUK_ContentCard$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$MTUK_ContentCard$update = F2(
	function (action, model) {
		var _p0 = action;
		switch (_p0.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$MTUK_ContentCard$Mdl, _p0._0, model);
			case 'ClickEdit':
				var _p1 = model.body;
				if (_p1.ctor === 'Nothing') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var editor_ = {body: _p1._0, passwd: ''};
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								editor: _elm_lang$core$Maybe$Just(editor_)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'EditorMsg':
				var _p2 = model.editor;
				if (_p2.ctor === 'Nothing') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p4 = _p2._0;
					...
					switch (_p3.ctor) {
						case 'ChangeBody':
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										editor: _elm_lang$core$Maybe$Just(
											_elm_lang$core$Native_Utils.update(
												_p4,
												{body: _p3._0}))
									}),
						...
						case 'ClickCancel':
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{editor: _elm_lang$core$Maybe$Nothing}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						default:
							var content_ = {key: model.key, value: _p4.body, editor: _elm_lang$core$Maybe$Nothing};
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				}
			default:
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							body: _elm_lang$core$Maybe$Just(
								_user$project$MTUK_LocalAPI$get(model.key))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$MTUK_ContentCard$editBtn = function (model) {
	return A5(
		_debois$elm_mdl$Material_Button$render,
		_user$project$MTUK_ContentCard$Mdl,
		{
			ctor: '::',
			_0: 0,
			_1: {
		...
		model.mdl,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$MTUK_Util$white,
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$onClick(_user$project$MTUK_ContentCard$ClickEdit),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$MTUK_ContentCard$saveBtn = function (model) {
	return A5(
		_debois$elm_mdl$Material_Button$render,
		_user$project$MTUK_ContentCard$Mdl,
		{
		...
		model.mdl,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Options$onClick(
				_user$project$MTUK_ContentCard$EditorMsg(_user$project$MTUK_ContentCard$ClickSave)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$MTUK_ContentCard$cancelBtn = function (model) {
	return A5(
		_debois$elm_mdl$Material_Button$render,
		_user$project$MTUK_ContentCard$Mdl,
		{
		...
		model.mdl,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Options$onClick(
				_user$project$MTUK_ContentCard$EditorMsg(_user$project$MTUK_ContentCard$ClickCancel)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$MTUK_ContentCard$view = function (model) {
	var _p5 = model.body;
	if (_p5.ctor === 'Nothing') {
		return A2(
			_debois$elm_mdl$Material_Card$view,
			_user$project$MTUK_ContentCard$options,
			{
				ctor: '::',
				_0: A2(
					_debois$elm_mdl$Material_Card$title,
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$MTUK_Util$spinnerGrid,
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$MTUK_ContentCard$editBtn(model),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
								...
								_0: A5(
									...
									model.mdl,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Textfield$value(_p7.body),
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$cs('markdown-content'),
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$onInput(
															function (x) {
																return _user$project$MTUK_ContentCard$EditorMsg(
																	_user$project$MTUK_ContentCard$ChangeBody(x));
															}),
														_1: {ctor: '[]'}
													}
												}
							...
							_0: A2(
								...
								},
								{
									...
									_0: A5(
										...
										model.mdl,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Textfield$value(_p7.passwd),
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$cs('small-textfield'),
														_1: {
															ctor: '::',
															_0: _debois$elm_mdl$Material_Options$onInput(
																function (x) {
																	return _user$project$MTUK_ContentCard$EditorMsg(
																		_user$project$MTUK_ContentCard$ChangePasswd(x));
																}),
															_1: {ctor: '[]'}
														}
													}
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _user$project$MTUK_ContentCard$saveBtn(model),
											_1: {
												ctor: '::',
												_0: _user$project$MTUK_ContentCard$cancelBtn(model),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$MTUK_SpeakerCard$viewSpeaker = function (speaker) {
	var blob = function () {
		var _p0 = speaker.blob;
		if (_p0.ctor === 'Nothing') {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('mdl-list__item mdl-list__item--three-line'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id(speaker.icon),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('material-icons mdl-list__item-avatar'),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('mdl-list__item-text-body'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$MTUK_SpeakerCard$options = {
	ctor: '::',
	_0: A2(_debois$elm_mdl$Material_Options$css, 'padding-left', '10px'),
	_1: {
		ctor: '::',
...
var _user$project$MTUK_SpeakerCard$model = {
	speakers: {
		ctor: '::',
		_0: _user$project$MTUK_SpeakerCard$speaker1,
		_1: {
			ctor: '::',
			_0: _user$project$MTUK_SpeakerCard$speaker2,
			_1: {
				ctor: '::',
				_0: _user$project$MTUK_SpeakerCard$speaker3,
				_1: {
					ctor: '::',
					_0: _user$project$MTUK_SpeakerCard$speaker4,
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$MTUK_SpeakerCard$Speaker = F4(
	function (a, b, c, d) {
		return {key: a, icon: b, name: c, blob: d};
	});
var _user$project$MTUK_SpeakerCard$Model = F3(
	function (a, b, c) {
		return {speakers: a, error: b, mdl: c};
	});
var _user$project$MTUK_SpeakerCard$Init = {ctor: 'Init'};
var _user$project$MTUK_SpeakerCard$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$MTUK_SpeakerCard$update = F2(
	function (action, model) {
		var _p1 = action;
		if (_p1.ctor === 'Mdl') {
			return A3(_debois$elm_mdl$Material$update, _user$project$MTUK_SpeakerCard$Mdl, _p1._0, model);
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$MTUK_SpeakerCard$view = function (model) {
	return A2(
		_debois$elm_mdl$Material_Card$view,
		{
			ctor: '::',
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Invited Speakers'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('mdl-list'),
								_1: {ctor: '[]'}
							},
							A2(_elm_lang$core$List$map, _user$project$MTUK_SpeakerCard$viewSpeaker, model.speakers)),
						_1: {
							ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A5(
								_debois$elm_mdl$Material_Button$render,
								_user$project$MTUK_SpeakerCard$Mdl,
								{
									ctor: '::',
									_0: 0,
									_1: {
...
var _user$project$MTUK_Overview$separator = A2(
	_debois$elm_mdl$Material_Options$div,
	{
		ctor: '::',
...
var _user$project$MTUK_Overview$supportCard = A2(_user$project$MTUK_ContentCard$model, 'support', '');
var _user$project$MTUK_Overview$introCard = A2(_user$project$MTUK_ContentCard$model, 'intro', 'British Postgraduate Model Theory Conference 2019');
var _user$project$MTUK_Overview$model = {introCard: _user$project$MTUK_Overview$introCard, speakerCard: _user$project$MTUK_SpeakerCard$model, supportCard: _user$project$MTUK_Overview$supportCard, mdl: _debois$elm_mdl$Material$model};
var _user$project$MTUK_Overview$Model = F4(
	function (a, b, c, d) {
		return {introCard: a, speakerCard: b, supportCard: c, mdl: d};
	});
var _user$project$MTUK_Overview$Init = {ctor: 'Init'};
var _user$project$MTUK_Overview$SupportCardMsg = function (a) {
	return {ctor: 'SupportCardMsg', _0: a};
};
var _user$project$MTUK_Overview$SpeakerCardMsg = function (a) {
	return {ctor: 'SpeakerCardMsg', _0: a};
};
var _user$project$MTUK_Overview$IntroCardMsg = function (a) {
	return {ctor: 'IntroCardMsg', _0: a};
};
var _user$project$MTUK_Overview$view = function (model) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Options$cs('page-content mdl-color--grey-100'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$MTUK_Overview$separator,
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$map,
					_user$project$MTUK_Overview$IntroCardMsg,
					_user$project$MTUK_ContentCard$view(model.introCard)),
				_1: {
					ctor: '::',
					_0: _user$project$MTUK_Overview$separator,
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$map,
							_user$project$MTUK_Overview$SpeakerCardMsg,
							_user$project$MTUK_SpeakerCard$view(model.speakerCard)),
						_1: {
							ctor: '::',
							_0: _user$project$MTUK_Overview$separator,
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$map,
									_user$project$MTUK_Overview$SupportCardMsg,
									_user$project$MTUK_ContentCard$view(model.supportCard)),
								_1: {
									ctor: '::',
									_0: _user$project$MTUK_Overview$separator,
									_1: {ctor: '[]'}
...
var _user$project$MTUK_Overview$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$MTUK_Overview$update = F2(
	function (action, model) {
		var _p0 = action;
		switch (_p0.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$MTUK_Overview$Mdl, _p0._0, model);
			case 'IntroCardMsg':
				return A6(
					...
					_user$project$MTUK_Overview$IntroCardMsg,
					_user$project$MTUK_ContentCard$update,
					_p0._0,
					model);
			case 'SpeakerCardMsg':
				return A6(
					...
					_user$project$MTUK_Overview$SpeakerCardMsg,
					_user$project$MTUK_SpeakerCard$update,
					_p0._0,
					model);
			case 'SupportCardMsg':
				return A6(
			...
			default:
				return A3(
					_user$project$MTUK_Util$andThen,
					_user$project$MTUK_Overview$update,
					_user$project$MTUK_Overview$SupportCardMsg(_user$project$MTUK_ContentCard$Init),
					A3(
						_user$project$MTUK_Util$andThen,
						_user$project$MTUK_Overview$update,
						_user$project$MTUK_Overview$SpeakerCardMsg(_user$project$MTUK_SpeakerCard$Init),
						A2(
							_user$project$MTUK_Overview$update,
							_user$project$MTUK_Overview$IntroCardMsg(_user$project$MTUK_ContentCard$Init),
							model)));
		}
	});

var _user$project$MTUK_Page$separator = A2(
	_debois$elm_mdl$Material_Options$div,
	{
		ctor: '::',
		_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-bottom', '48px'),
...
var _user$project$MTUK_Page$model = F2(
	function (key, title) {
		return {
			contentCard: A2(_user$project$MTUK_ContentCard$model, key, title),
			mdl: _debois$elm_mdl$Material$model
		};
	});
var _user$project$MTUK_Page$Model = F2(
	function (a, b) {
		return {contentCard: a, mdl: b};
	});
var _user$project$MTUK_Page$Init = {ctor: 'Init'};
var _user$project$MTUK_Page$ContentCardMsg = function (a) {
	return {ctor: 'ContentCardMsg', _0: a};
};
var _user$project$MTUK_Page$view = function (model) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$MTUK_Page$separator,
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$map,
					_user$project$MTUK_Page$ContentCardMsg,
					_user$project$MTUK_ContentCard$view(model.contentCard)),
				_1: {
					ctor: '::',
					_0: _user$project$MTUK_Page$separator,
					_1: {ctor: '[]'}
...
var _user$project$MTUK_Page$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$MTUK_Page$update = F2(
	function (action, model) {
		update:
		while (true) {
			var _p0 = action;
			switch (_p0.ctor) {
				case 'Mdl':
					return A3(_debois$elm_mdl$Material$update, _user$project$MTUK_Page$Mdl, _p0._0, model);
				case 'ContentCardMsg':
					return A6(
						_debois$elm_mdl$Material_Helpers$lift,
						function (_) {
							return _.contentCard;
						},
						F2(
							function (m, x) {
								return _elm_lang$core$Native_Utils.update(
						...
						model);
				default:
					var _v1 = _user$project$MTUK_Page$ContentCardMsg(_user$project$MTUK_ContentCard$Init),
						_v2 = model;
					action = _v1;
					model = _v2;
					continue update;
...
var _user$project$MTUK_ScheduleCard$titlebar = function (model) {
	return A2(
		_debois$elm_mdl$Material_Card$title,
		{
			ctor: '::',
...
var _user$project$MTUK_ScheduleCard$options = {
	ctor: '::',
	_0: _debois$elm_mdl$Material_Options$cs('mld-cell mdl-cell--4col schedulecard'),
	_1: {
		ctor: '::',
		_0: _debois$elm_mdl$Material_Color$background(_debois$elm_mdl$Material_Color$white),
		_1: {
...
var _user$project$MTUK_ScheduleCard$model = F2(
	function (key_, title_) {
		return {key: key_, title: title_, body: _elm_lang$core$Maybe$Nothing, editor: _elm_lang$core$Maybe$Nothing, mdl: _debois$elm_mdl$Material$model};
	});
var _user$project$MTUK_ScheduleCard$EditorModel = F2(
	function (a, b) {
		return {body: a, passwd: b};
	});
var _user$project$MTUK_ScheduleCard$Model = F5(
	function (a, b, c, d, e) {
		return {key: a, title: b, body: c, editor: d, mdl: e};
	});
var _user$project$MTUK_ScheduleCard$ClickCancel = {ctor: 'ClickCancel'};
var _user$project$MTUK_ScheduleCard$ClickSave = {ctor: 'ClickSave'};
var _user$project$MTUK_ScheduleCard$ChangePasswd = function (a) {
	return {ctor: 'ChangePasswd', _0: a};
};
var _user$project$MTUK_ScheduleCard$ChangeBody = function (a) {
	return {ctor: 'ChangeBody', _0: a};
};
var _user$project$MTUK_ScheduleCard$Init = {ctor: 'Init'};
var _user$project$MTUK_ScheduleCard$EditorMsg = function (a) {
	return {ctor: 'EditorMsg', _0: a};
};
var _user$project$MTUK_ScheduleCard$ClickEdit = {ctor: 'ClickEdit'};
var _user$project$MTUK_ScheduleCard$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$MTUK_ScheduleCard$update = F2(
	function (action, model) {
		var _p0 = action;
		switch (_p0.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$MTUK_ScheduleCard$Mdl, _p0._0, model);
			case 'ClickEdit':
				var _p1 = model.body;
				if (_p1.ctor === 'Nothing') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'EditorMsg':
				...
				if (_p2.ctor === 'Nothing') {
					...
					switch (_p3.ctor) {
						...
						default:
							var content_ = {key: model.key, value: _p4.body};
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										body: _elm_lang$core$Maybe$Just(_p4.body),
										editor: _elm_lang$core$Maybe$Nothing
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
...
var _user$project$MTUK_ScheduleCard$editBtn = function (model) {
	return A5(
		_debois$elm_mdl$Material_Button$render,
		_user$project$MTUK_ScheduleCard$Mdl,
		{
			ctor: '::',
			_0: 0,
			_1: {
		...
		model.mdl,
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$onClick(_user$project$MTUK_ScheduleCard$ClickEdit),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$MTUK_ScheduleCard$saveBtn = function (model) {
	return A5(
		_debois$elm_mdl$Material_Button$render,
		_user$project$MTUK_ScheduleCard$Mdl,
		{
		...
		model.mdl,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Options$onClick(
				_user$project$MTUK_ScheduleCard$EditorMsg(_user$project$MTUK_ScheduleCard$ClickSave)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$MTUK_ScheduleCard$cancelBtn = function (model) {
	return A5(
		_debois$elm_mdl$Material_Button$render,
		_user$project$MTUK_ScheduleCard$Mdl,
		{
		...
		model.mdl,
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Options$onClick(
				_user$project$MTUK_ScheduleCard$EditorMsg(_user$project$MTUK_ScheduleCard$ClickCancel)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$MTUK_ScheduleCard$view = function (model) {
	var _p5 = model.body;
	if (_p5.ctor === 'Nothing') {
		return A2(
			_debois$elm_mdl$Material_Card$view,
			_user$project$MTUK_ScheduleCard$options,
			{
				ctor: '::',
				_0: _user$project$MTUK_ScheduleCard$titlebar(model),
				_1: {
					ctor: '::',
					_0: A2(
						_debois$elm_mdl$Material_Card$text,
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$MTUK_ScheduleCard$editBtn(model),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
											...
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_0: _debois$elm_mdl$Material_Options$onInput(
															function (x) {
																return _user$project$MTUK_ScheduleCard$EditorMsg(
																	_user$project$MTUK_ScheduleCard$ChangeBody(x));
															}),
														_1: {ctor: '[]'}
													}
												}
							...
							_0: A2(
								...
								},
								{
													...
													_1: {
														...
														_1: {
															...
															_0: _debois$elm_mdl$Material_Options$onInput(
																function (x) {
																	return _user$project$MTUK_ScheduleCard$EditorMsg(
																		_user$project$MTUK_ScheduleCard$ChangePasswd(x));
																}),
															_1: {ctor: '[]'}
														}
													}
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _user$project$MTUK_ScheduleCard$saveBtn(model),
											_1: {
												ctor: '::',
												_0: _user$project$MTUK_ScheduleCard$cancelBtn(model),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$MTUK_Schedule$separator = A2(
	_debois$elm_mdl$Material_Options$div,
	{
		ctor: '::',
		_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-bottom', '48px'),
...
var _user$project$MTUK_Schedule$abstractsCard = A2(_user$project$MTUK_ContentCard$model, 'abstracts', 'Abstracts');
var _user$project$MTUK_Schedule$dayCard = function (n) {
	return A2(
		_user$project$MTUK_ScheduleCard$model,
		A2(
			_elm_lang$core$Basics_ops['++'],
			'day',
			_elm_lang$core$Basics$toString(n)),
...
var _user$project$MTUK_Schedule$model = {
	day1Card: _user$project$MTUK_Schedule$dayCard(1),
	day2Card: _user$project$MTUK_Schedule$dayCard(2),
	day3Card: _user$project$MTUK_Schedule$dayCard(3),
	abstractsCard: _user$project$MTUK_Schedule$abstractsCard,
	mdl: _debois$elm_mdl$Material$model
};
var _user$project$MTUK_Schedule$Model = F5(
	function (a, b, c, d, e) {
		return {day1Card: a, day2Card: b, day3Card: c, abstractsCard: d, mdl: e};
	});
var _user$project$MTUK_Schedule$Init = {ctor: 'Init'};
var _user$project$MTUK_Schedule$AbstractsCardMsg = function (a) {
	return {ctor: 'AbstractsCardMsg', _0: a};
};
var _user$project$MTUK_Schedule$Day3CardMsg = function (a) {
	return {ctor: 'Day3CardMsg', _0: a};
};
var _user$project$MTUK_Schedule$Day2CardMsg = function (a) {
	return {ctor: 'Day2CardMsg', _0: a};
};
var _user$project$MTUK_Schedule$Day1CardMsg = function (a) {
	return {ctor: 'Day1CardMsg', _0: a};
};
var _user$project$MTUK_Schedule$view = function (model) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$MTUK_Schedule$separator,
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$map,
									_user$project$MTUK_Schedule$Day1CardMsg,
									_user$project$MTUK_ScheduleCard$view(model.day1Card)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$map,
										_user$project$MTUK_Schedule$Day2CardMsg,
										_user$project$MTUK_ScheduleCard$view(model.day2Card)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											_elm_lang$html$Html$map,
											_user$project$MTUK_Schedule$Day3CardMsg,
											_user$project$MTUK_ScheduleCard$view(model.day3Card)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$map,
							_user$project$MTUK_Schedule$AbstractsCardMsg,
							_user$project$MTUK_ContentCard$view(model.abstractsCard)),
						_1: {
							ctor: '::',
							_0: _user$project$MTUK_Schedule$separator,
							_1: {ctor: '[]'}
...
var _user$project$MTUK_Schedule$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$MTUK_Schedule$update = F2(
	function (action, model) {
		var _p0 = action;
		switch (_p0.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$MTUK_Schedule$Mdl, _p0._0, model);
			case 'Day1CardMsg':
				return A6(
					_debois$elm_mdl$Material_Helpers$lift,
					function (_) {
					...
					_user$project$MTUK_Schedule$Day1CardMsg,
					_user$project$MTUK_ScheduleCard$update,
					_p0._0,
					model);
			case 'Day2CardMsg':
				return A6(
			...
			case 'Day3CardMsg':
				return A6(
					...
					_p0._0,
					model);
			case 'AbstractsCardMsg':
				return A6(
					_debois$elm_mdl$Material_Helpers$lift,
					function (_) {
						return _.abstractsCard;
					},
					F2(
						function (m, x) {
							return _elm_lang$core$Native_Utils.update(
			...
			default:
				return A3(
					_user$project$MTUK_Util$andThen,
					_user$project$MTUK_Schedule$update,
					_user$project$MTUK_Schedule$Day3CardMsg(_user$project$MTUK_ScheduleCard$Init),
					A3(
						_user$project$MTUK_Util$andThen,
						_user$project$MTUK_Schedule$update,
						_user$project$MTUK_Schedule$Day2CardMsg(_user$project$MTUK_ScheduleCard$Init),
						A3(
							_user$project$MTUK_Util$andThen,
							_user$project$MTUK_Schedule$update,
							_user$project$MTUK_Schedule$Day1CardMsg(_user$project$MTUK_ScheduleCard$Init),
							A2(
								_user$project$MTUK_Schedule$update,
								_user$project$MTUK_Schedule$AbstractsCardMsg(_user$project$MTUK_ContentCard$Init),
								model))));
		}
	});
...
var _user$project$Main$model = {
	mdl: _debois$elm_mdl$Material$model,
	overview: _user$project$MTUK_Overview$model,
	schedule: _user$project$MTUK_Schedule$model,
	venue: A2(_user$project$MTUK_Page$model, 'venue', 'Venue'),
	information: A2(_user$project$MTUK_Page$model, 'information', 'Information'),
	selectedTab: 0,
	logMessages: false
};
var _user$project$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {mdl: a, overview: b, schedule: c, venue: d, information: e, selectedTab: f, logMessages: g};
	});
var _user$project$Main$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Main$drawerLink = function (_p1) {
	var _p2 = _p1;
	return A2(
...
var _user$project$Main$registerBtn = A5(
	_debois$elm_mdl$Material_Button$render,
	...
	_user$project$Main$model.mdl,
	{
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Button$link('#info'),
					_1: {ctor: '[]'}
				}
			}
		}
	...
	return {
		...
		_0: A2(
			_debois$elm_mdl$Material_Layout$row,
			{
				...
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Options$cs('mdl-layout__header-animated'),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$cs('mdl-layout--small-screen-only'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('BPGMTC 2019'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$cs('mdl-layout--large-screen-only'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$src('./images/title-web-main.png'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$alt('BPGMTC 2019'),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Main$registerBtn,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Main$ToggleLog = {ctor: 'ToggleLog'};
var _user$project$Main$InformationMsg = function (a) {
	return {ctor: 'InformationMsg', _0: a};
};
var _user$project$Main$VenueMsg = function (a) {
	return {ctor: 'VenueMsg', _0: a};
};
var _user$project$Main$ScheduleMsg = function (a) {
	return {ctor: 'ScheduleMsg', _0: a};
};
var _user$project$Main$OverviewMsg = function (a) {
	return {ctor: 'OverviewMsg', _0: a};
};
		...
		switch (_p3.ctor) {
			...
			case 'OverviewMsg':
				return A6(
					...
					_user$project$Main$OverviewMsg,
					_user$project$MTUK_Overview$update,
					_p3._0,
					model);
			case 'ScheduleMsg':
				return A6(
					...
					_user$project$Main$ScheduleMsg,
					_user$project$MTUK_Schedule$update,
					_p3._0,
					model);
			case 'VenueMsg':
				return A6(
					...
					_user$project$Main$VenueMsg,
					_user$project$MTUK_Page$update,
					_p3._0,
					model);
			case 'InformationMsg':
				return A6(
					...
					_user$project$Main$InformationMsg,
					_user$project$MTUK_Page$update,
					_p3._0,
					model);
			case 'Mdl':
				return A3(
					...
					A3(_debois$elm_mdl$Material$update, _user$project$Main$Mdl, _p3._0, model));
			default:
				return A3(
					_user$project$MTUK_Util$andThen,
					_user$project$Main$update,
					_user$project$Main$InformationMsg(_user$project$MTUK_Page$Init),
					A3(
						_user$project$MTUK_Util$andThen,
						_user$project$Main$update,
						_user$project$Main$VenueMsg(_user$project$MTUK_Page$Init),
						A3(
							_user$project$MTUK_Util$andThen,
							_user$project$Main$update,
							_user$project$Main$ScheduleMsg(_user$project$MTUK_Schedule$Init),
							A2(
								_user$project$Main$update,
								_user$project$Main$OverviewMsg(_user$project$MTUK_Overview$Init),
								model))));
		}
	});
	...
	_0: {
		...
		_2: function (_p4) {
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Main$OverviewMsg,
				_user$project$MTUK_Overview$view(
					function (_) {
						return _.overview;
					}(_p4)));
		}
		...
		_0: {
			...
			_2: function (_p5) {
				return A2(
					_elm_lang$html$Html$map,
					_user$project$Main$ScheduleMsg,
					_user$project$MTUK_Schedule$view(
						function (_) {
							return _.schedule;
						}(_p5)));
			}
	...
	return {
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$src('./images/logo-mobile.png'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {ctor: '[]'}
		...
		_1: {
			...
			_0: A2(
				_debois$elm_mdl$Material_Layout$navigation,
				{ctor: '[]'},
				A2(_elm_lang$core$List$map, _user$project$Main$drawerLink, _user$project$Main$tabs)),
			_1: {ctor: '[]'}
		}
	};
};
			...
			tabs: {
				...
				_1: {
					...
					_0: _debois$elm_mdl$Material_Color$background(
						A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$DeepPurple, _debois$elm_mdl$Material_Color$S400)),
					_1: {ctor: '[]'}
				}
			},
			main: {
			...
			if (_p16 === '') {
				...
				return _user$project$Main$SelectTab(
					A2(
						_elm_lang$core$Maybe$withDefault,
						-1,
						A2(_elm_lang$core$Dict$get, _p16, _user$project$Main$urlTabs)));
			}
		}(),
		_1: {ctor: '[]'}
	};
